...
#define MOMENTUM 0.6 //momentum coefficient, works on when defined NEED_MOMENTUM， 定义动量项
...
#endif
  double m_dActivation; //output value, through Sigmoid function 函数输出
  double m_dError; //error value of neuron  神经元误差
